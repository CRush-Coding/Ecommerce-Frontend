          ...
          <div className="row">
            <div className="col-4">
              ...
              <div>
                ...
                <a href="tel:+91 8264954324" className="mt-3 d-block mb-1 text-white">
                  +91 8264954234
                </a>
                <a href="mailto:4" className="mt-2 d-block mb-0 text-white">
                  someguy@gmail.com
                </a>
            ...
            <div className="col-3">
              ...
              <div className='footer-links d-flex flex-column'>
                <Link to='/privacy-policy' className="text-white py-2 mb-1">Pirvacy Policy</Link>
